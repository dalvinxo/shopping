...
EXPLAIN SELECT c.id_company, c.image_company, c.name_company, c.social_company, c.phone_company, c.country_company, c.addres_company, c.status_company, COUNT(o.id_orders) as orders 
FROM orderUser AS o 
RIGHT JOIN companyUser AS c 
ON o.fk_id_company = c.id_company 
WHERE c.fk_id_usuario = '11'